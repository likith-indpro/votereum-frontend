...
const Login = () => {
  ...
  useEffect(() => {
    ...
    // Check if we're coming from registration page
  ...
  return (
    <div className="flex min-h-[600px]  min-w-2xl bg-white rounded-xl shadow-lg overflow-hidden">
      ...
      >
        <div className="text-center">
          ...
          <p className="text-blue-100 text-lg mb-8">
            Sign in to access your account and continue voting with blockchain
            security.
          </p>
          <div className="mb-8">
            <svg
